...
let blaslibs = (Sys.ARCH === :x86_64) || (Sys.ARCH === :i686) ? [("mkl", :Int32, ""),("openblas", :Int64, "_64_"),("blis", :Int64, "_64_")] : [("openblas", :Int64, "_64_"),("blis", :Int64, "_64_")]
    for (name,typ,suff) ∈ blaslibs
